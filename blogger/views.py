...
def detail(request, id, slug):
    ...
    if request.is_ajax():
        html = render_to_string('blogger/comments.html', context, request=request)
...
def post_favourite_list(request):
    ...
    return render(request, 'blogger/favourite_list.html', context)
...
def like_post(request):
    ...
    if request.is_ajax():
        html = render_to_string('blogger/like_section.html', context, request=request)
        return JsonResponse({'form': html})
def post_create(request):
    ...
    return render(request, 'blogger/post_create.html', context)
...
def post_edit(request, id):
    ...
    return render(request, 'blogger/post_edit.html', context)
...
def edit_profile(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            user_form.save()
            profile_form.save()
            return HttpResponseRedirect(reverse("blogger:edit_profile"))
    else:
    ...
    return render(request, 'blogger/edit_profile.html', context)
